...
const topicsURL = "https://storagecdopenai.blob.core.windows.net/$web/topics.json"
// const QAsURL = "https://fabconworkshopalvidela.blob.core.windows.net/$web/generated-QAs.json"
const QAsURL = "https://storagecdopenai.blob.core.windows.net/$web/generated-QAs.json"
